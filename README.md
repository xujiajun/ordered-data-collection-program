...
<img src="https://user-images.githubusercontent.com/6065007/78799302-880cbb80-79ec-11ea-8432-dd8fd9860225.png"></img>
...
关于数据的接收，通过定义一个`dataChan`来作上游生产方的消息中转，把流控和过滤后的data往里面放，相当于队列的作用，再for select去监听这个`dataChan`处理就可以了。
